  ...
  <div id="editor">
    <div class="columns is-gapless">
      <div class="column is-2 func-div">
        ...
        <div class="line"></div>
        <div class="has-text-centered has-text-white func-button" :class="{'func-selected' : module == 0}" @click="changeModule(0)">
          <span class="icon is-small"><i class="fa fa-window-restore"></i></span>
          <span class="func-button-text">场景</span>
        </div>
        <div class="line"></div>
        <div class="has-text-centered has-text-white func-button" :class="{'func-selected' : module == 1}" @click="changeModule(1)">
          <span class="icon is-small"><i class="fa fa-eye"></i></span>
          <span class="func-button-text">视角</span>
        </div>
        <div class="line"></div>
        <div class="has-text-centered has-text-white func-button" :class="{'func-selected' : module == 2}" @click="changeModule(2)">
        ...
        <div class="scene-module has-text-white" v-show="module == 0">
          ...
          <div class="scene-item" v-for="scene in sceneList" :class="{'scene-item-selected' : scene.index == currentSceneIndex}" v-bind:key="scene.name">
            ...
            <div class="pencil" @click="showModifySceneName(scene)">
              <a class="button is-primary is-inverted is-outlined"><span class="icon"><i class="fa fa-pencil"></i></span></a>
            </div>
            <div class="home" @click="setWelcome(scene.index)">
              <a class="button is-primary is-inverted is-outlined" :class="{'home-selected': scene.index == welcomeSceneIndex}">
                <span class="icon"><i class="fa fa-home"></i></span>
              </a>
            </div>
          </div>
        </div>
        <div class="view-module has-text-white" v-show="module == 1" @mousemove="moveInitFov()" @mouseup="stopMoveInitFov()">
          <div class="view-content">
            ...
            <label class="label has-text-white">
              等待时间（秒）
              <input class="input is-small" :disabled="!autoSpinFlag" v-model="autoSpinWaitingTime" @change="updatedAutoSpin()">
            </label>
          </div>
          <div class="line"></div>
          <div class="view-content">
            <div class="view-slider">
              ...
              <vue-slider v-model="sliderValue" :max="180" :tooltipDir="['bottom','bottom']" :dotSize="12" :show="module == 1"></vue-slider>
            </div>
